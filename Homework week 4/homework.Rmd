...
#This is not a great markdown doc I know 
Loading packages 
...
library(tmap)
library(tidyverse)
library(countrycode) #To match the countrycodes
```
...
#cleaning and shaping the data for map making 
```{r Editing/Merging/Reshaping}
data <- gender_inequal %>%
